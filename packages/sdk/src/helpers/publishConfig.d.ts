 ...
 */
export type UploadExecutor = (upload: PublishUpload) => Promise<{
    txId: string;
}>;
export declare function setUploadExecutor(executor: UploadExecutor | null): void;
export declare function getUploadExecutor(): UploadExecutor | null;
