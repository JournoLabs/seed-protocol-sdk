...
export type GetItemData = (params: GetItemDataParams) => Promise<ItemData | undefined>;
...
export type GetItemProperties = (props: GetPropertiesForSeedProps) => Promise<PropertyData[]>;
