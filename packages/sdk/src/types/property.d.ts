...
import { TProperty, TPropertyDataType, TPropertyDefs, TStorageType } from '@/Schema';
...
export type PropertyValue = string | number | boolean | null | Record<string, unknown> | Record<string, unknown>[];
...
export type ItemPropertyValueType = string | number | Record<string, unknown> | null | undefined | any[];
