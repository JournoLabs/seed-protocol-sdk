...
import type { CreateArweaveTransactionsResult } from './createArweaveTransactions'

type PublishInput = { input: { context: PublishMachineContext; event: unknown } }

/** Phase 2: deferred Html storage files only (after embedded images uploaded + Html rewritten). */
export const createArweaveTransactionsPhase2 = fromPromise(
